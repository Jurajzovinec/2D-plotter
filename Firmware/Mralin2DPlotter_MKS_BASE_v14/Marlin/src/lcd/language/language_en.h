...
namespace Language_en {
  ...
  PROGMEM Language_Str MSG_START_PRINT                     = _UxGT("Start Draw");
  ...
  PROGMEM Language_Str MSG_BUTTON_PRINT                    = _UxGT("Draw");
  ...
  PROGMEM Language_Str MSG_PAUSE_PRINT                     = _UxGT("Pause Draw");
  PROGMEM Language_Str MSG_RESUME_PRINT                    = _UxGT("Resume Draw");
  PROGMEM Language_Str MSG_HOST_START_PRINT                = _UxGT("Host Start");
  PROGMEM Language_Str MSG_STOP_PRINT                      = _UxGT("Stop Draw");
  PROGMEM Language_Str MSG_END_LOOPS                       = _UxGT("End Repeat Loops");
  PROGMEM Language_Str MSG_PRINTING_OBJECT                 = _UxGT("Drawing Object");
  ...
  PROGMEM Language_Str MSG_MEDIA_MENU                      = _UxGT("Draw from Media");
  ...
  PROGMEM Language_Str MSG_PRINT_PAUSED                    = _UxGT("Draw Paused");
  PROGMEM Language_Str MSG_PRINTING                        = _UxGT("Drawing...");
  PROGMEM Language_Str MSG_PRINT_ABORTED                   = _UxGT("Draw Aborted");
  PROGMEM Language_Str MSG_PRINT_DONE                      = _UxGT("Draw Done");
  ...
  PROGMEM Language_Str MSG_INFO_MENU                       = _UxGT("About Plotter");
  PROGMEM Language_Str MSG_INFO_PRINTER_MENU               = _UxGT("Plotter Info");
  ...
  PROGMEM Language_Str MSG_INFO_STATS_MENU                 = _UxGT("Plotter Stats");
  ...
  #if LCD_WIDTH >= 20
    PROGMEM Language_Str MSG_INFO_PRINT_COUNT              = _UxGT("Plotter Count");
    PROGMEM Language_Str MSG_INFO_COMPLETED_PRINTS         = _UxGT("Completed");
    PROGMEM Language_Str MSG_INFO_PRINT_TIME               = _UxGT("Total drawing Time");
  ...
  PROGMEM Language_Str MSG_FILAMENT_CHANGE_HEADER_PAUSE    = _UxGT("Drawing PAUSED");
  ...
  //
  #if LCD_HEIGHT >= 4
    PROGMEM Language_Str MSG_ADVANCED_PAUSE_WAITING        = _UxGT(MSG_2_LINE("Press Button", "to resume drawing"));
    ...
    PROGMEM Language_Str MSG_FILAMENT_CHANGE_RESUME        = _UxGT(MSG_2_LINE("Wait for draw", "to resume..."));
  #else
