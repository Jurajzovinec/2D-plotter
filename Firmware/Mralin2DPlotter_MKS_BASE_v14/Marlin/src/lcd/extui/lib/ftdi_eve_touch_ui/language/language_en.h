...
namespace Language_en {
  ...
  PROGMEM Language_Str MSG_ACCEL_PRINTING           = u8"Drawing";
  ...
  PROGMEM Language_Str MSG_PRINT_STARTING           = u8"Draw starting";
  PROGMEM Language_Str MSG_PRINT_FINISHED           = u8"Draw finished";
  PROGMEM Language_Str MSG_PRINT_ERROR              = u8"Draw error";
  ...
  PROGMEM Language_Str MSG_PRINT_SPEED              = u8"Draw Speed";
  ...
  PROGMEM Language_Str MSG_START_PRINT_CONFIRMATION = u8"Start drawing of %s?";
  PROGMEM Language_Str MSG_ABORT_WARNING            = u8"Are you sure you want to cancel the plotting?";
