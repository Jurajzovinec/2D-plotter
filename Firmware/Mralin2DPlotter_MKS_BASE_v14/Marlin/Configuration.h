...
***********************************************************************/
// Juraj Name Printer
#define PRINTER_NAME " Zovinec 2D config "  // Change this to whatever you wish, or leave it as it is.
...
//#define LARGE_BED
#define SDSUPPORT
// Juraj Change Y direction
#define CHANGE_Y_DIRECTION
// Juraj CHANGE_X_DIRECTION 
...
// Juraj MOTHERBOARD
#define MOTHERBOARD BOARD_MKS_BASE_14        // Original controller board with built in stepper drivers. Works with MKS BASE 1.3, 1.4
...
#define STRING_CONFIG_H_AUTHOR "(Juraj Zovinec, Edited Jim Browns work for purposes of plotting images)" // Who made the changes.
...
// Juraj TEMP_SENSOR_BED set to 0
...
//#define DEBUG_LEVELING_FEATURE
  ...
  **/
  ...
  // Juraj - turn  off mesh validation since we have no extruders.
...
#define SERVO_DELAY { 520 }
#define DEACTIVATE_SERVOS_AFTER_MOVE
// #define EDITABLE_SERVO_ANGLES
// #define Z_SERVO_ANGLES { SERVO_DEPLOY, SERVO_STOW }

// Juraj Turned of proble inverting
// #define Z_MIN_PROBE_ENDSTOP_INVERTING
// #define Z_PROBE_SERVO_NR 0


/*
not related to documentation. Is just a config file issue, as explained in discord. To enable M281 you need to have EDITABLE_SERVO_ANGLES and one of these set Z_PROBE_SERVO_NR, SWITCHING_EXTRUDER, SWITCHING_NOZZLE ie something that has a servo.
*/
...
// Juraj Edit servo angles with M281 and save to EEPROM with M500
